...
Here, we use the `usecol()` function to extend our color palette `pal_princeton_1` to 15\ colors and illustrate the resulting color palette `my_pal` with the `demopal()` function:
