...
The **unikn** package facilitas the use of corporate design elements for users of [R](https://www.r-project.org/). 
While the correct use of default specifications is simple and straightforward, we leave some flexibility for more experienced users (e.g., for creating scientific visualizations). 
...
```{r seecol-pref, eval = TRUE, fig.align = 'center', fig.width = 7, fig.height = 5.5}
...
```{r pal-n, eval = TRUE, out.width = "67%", fig.asp = .75, fig.align = 'center', collapse = TRUE}
# All color palettes: ----- 
seecol(n = 4)
...
```{r col-scale-1, eval = TRUE, out.width = "67%", fig.asp = .75, fig.align = 'center', collapse = TRUE}
...
```{r col-scale-3, eval = TRUE, out.width = "67%", fig.asp = .75, fig.align = 'center', collapse = TRUE}
# Combining color palettes (and colors): ----- 
seecol(c(rev(pal_petrol),  "white", pal_bordeaux), 11,
       col_bg = "grey90")
```

```{r col-scale-3-b, eval = FALSE, out.width = "67%", fig.asp = .75, fig.align = 'center', collapse = TRUE}
...
```{r usepal-demo-barplot-1, eval = TRUE, out.width = "60%", fig.asp = .65, fig.align = 'center', collapse = TRUE}
...
```{r use-pal-ggplot2, eval = FALSE, out.width = "60%", fig.asp = .618, fig.align = 'center', collapse = TRUE}
...
The color scales included in the **unikn** package are based on the CD manual of the [University of Konstanz](https://www.uni-konstanz.de/), Germany. 
...
```{r uni-Cardiff, echo = FALSE, eval = FALSE, fig.align = 'center', fig.width = 5, fig.height = 3}
...
```{r uni-freiburg-cols, out.width = "67%", fig.asp = .75, fig.align = 'center', fig.show = "hold", collapse = TRUE}
...
```{r uni-freiburg-seecol, out.width = "67%", fig.asp = .75, fig.align = 'center', collapse = TRUE}
...
```{r uni-princeton-ggplot, eval = FALSE, out.width = "60%", fig.asp = .618, fig.align = 'center', collapse = TRUE}
# View color palette: 
# seecol(pal_princeton_1)  
...
```{r mpg-rgb-cols, echo = FALSE, eval = FALSE, out.width = "67%", fig.asp = .75, fig.align = 'center', collapse = TRUE}
# Using RGB values: 
...
```{r mpg-pal-def, out.width = "67%", fig.asp = .75, fig.align = 'center', collapse = TRUE}
...
```{r mpg-use-pal, eval = TRUE, fig.width = 3.5, fig.height = 4, fig.show = 'hold', fig.align = 'center'}
# View color palette: 
# seecol(pal_mpg)
...
```{r compare-custom-pals, out.width = "75%", fig.asp = .50, fig.align = 'center', collapse = TRUE}
...
```{r heading-demo, echo = TRUE, eval = TRUE, fig.align = 'center', fig.width = 2, fig.height = 3}
...
```{r others-txt-demo, echo = TRUE, eval = TRUE, fig.align = 'center', fig.width = 5, fig.height = 3.5}
...
We are members of the research group on [Social Psychology and Decision Sciences](https://www.spds.uni-konstanz.de/) at the [University of Konstanz](https://www.uni-konstanz.de/) and make some CD elements available to fellow users of R (e.g., for creating scientific visualizations). 
However, all copyrights on the CD remain with the original copyright holders. 
