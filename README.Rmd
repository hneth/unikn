...
```{r use_pal_ggplot2, eval = FALSE, out.width = "67%", fig.asp = .618, fig.align = 'center', collapse = TRUE}
...
The color scales included in the **unikn** package are based on those used by our own institution (the [University of Konstanz](https://uni-konstanz.de), Germany). 
...
```{r MPG_hex, out.width = "67%", fig.asp = .75, fig.align = 'center', collapse = TRUE}
# Using HEX values:
mpg_green <- "#007367"
mpg_grey  <- "#D0D3D4"
