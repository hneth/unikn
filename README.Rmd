...
```{r pal_unikn, eval = TRUE, fig.width = 7, fig.asp = .75, fig.align = 'center'}
...
```{r pal_all, eval = TRUE, fig.align = 'center', fig.width = 5, fig.height = 5}
seecol("all")
```
...
the nine preferred colors of `pal_unikn_pref` (e.g., `Seeblau`, `Seegruen`, etc.) as named colors. 
...
```{r grepal-example-2, fig.width=5, fig.asp=.50, fig.align = 'center'}
# Find colors:
