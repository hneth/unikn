...
```{r pal_unikn, eval = TRUE, fig.align = 'center', fig.width = 7, fig.height = 5}
...
```{r pal_all, eval = TRUE, fig.align = 'center', fig.width = 7, fig.height = 6}
seecol("all")
```
...
```{r seecol_pref, eval = TRUE, fig.align = 'center', fig.width = 7, fig.height = 5}
...
The `seecol` function provides color gradients based on given colors or color palettes. 
...
```{r use_pal_ggplot2, eval = TRUE, out.width = "75%", fig.asp = .75, fig.align = 'center'}
...
```{r post_demo, echo = TRUE, eval = TRUE, fig.align = 'center', fig.width = 2, fig.height = 2}
