...
While the correct use of default specifications should be simple and straightforward, we also allow some flexibility for expert users (e.g., for the creation of scientific visualizations). 
...
Hence, to preserve the crisp look of the original plots, plots should be generated and viewed in the desired size (in R) and displayed without further scaling (in other media):[^2] 
