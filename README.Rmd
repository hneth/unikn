...
2. Secondary color palette (`pal_unikn_ppt`): 
An alternative color palette with more muted colors (intended for PowerPoint presentations) is provided as `pal_unikn_ppt`. 
...
The following additional color palettes are defined in an Excel file on [Colours for complex graphics](https://www.uni-konstanz.de/en/university/news-and-media/create-online-and-print-media/corporate-design/colours-for-complex-graphics/) 
