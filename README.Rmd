...
2. Functions for **viewing and comparing**, and for **changing and using** color palettes (`seecol()` and\ `usecol()`);  
...
[File `README.md` last updated on `r Sys.Date()`.]
