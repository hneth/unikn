...
The **unikn** package enables the use some elements of the [University of Konstanz](https://www.uni-konstanz.de/)'s corporate design for users of [R](https://www.r-project.org/). 
...
```{r pal_unikn, eval = TRUE, fig.align = 'center', fig.width = 8, fig.height = 6}
...
```{r seecol_pref, eval = TRUE, fig.align = 'center', fig.width = 8, fig.height = 5}
