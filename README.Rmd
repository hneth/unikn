...
# unikn `r packageVersion('unikn')` <img src = "./logo.png" align = "right" alt = "unikn" width = "160" />
...
- over 270\ color palettes of more than 110\ additional institutions are now provided by the **[unicol](`r url_unicol_cran`)** package
...
Installing **[unicol](`r url_unicol_cran`)** currently provides access to a diverse range of over **270\ color palettes** from more than **110\ institutions**. 
...
uni_freiburg_br <- unicol::uni_freiburg_br  # now part of unicol
...
mark(labels = c("Die Wahrheit", "wird euch", "frei machen."), 
     ...
     col = c("white"), col_bg = rev(usecol(uni_freiburg_br, 3)))

# B. Using orange_white or uni_princeton_0:
uni_princeton_2 <- unicol::princeton_2  # now part of unicol
uline(labels = c("Princeton University"), 
      x = x_pos, y = .55, font = 2, cex = 1, col_bg = uni_princeton_2[1])
mark(#labels = c("In the nation’s", "service and the", "service of humanity."), 
     labels = c("Go", "tigers!"), 
     x = 0, y = .58, y_layout = 0, cex = 1.2,  
     col = c("black", "white"), col_bg = uni_princeton_2)

# C. Using mpg_pal (no longer exported):
mpg_pal <- unicol::mpg  # now part of unicol
