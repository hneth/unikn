...
former versions of **unikn** provided color palettes of many other institutions. 
...
```{r seecol-add-pals, echo = FALSE, eval = FALSE, fig.width = 7.2, out.width = "550px", fig.align = 'center', fig.asp = 2.0}
