...
```{r simcol-example, fig.width = 5, fig.asp = .9, fig.align = 'center'}
...
```{r grepal-example-1, fig.width = 5, fig.asp = .9, fig.align = 'center', message=FALSE}
...
```{r grepal-example-2, fig.width = 8, fig.asp = .30, fig.align = 'center', message=FALSE}
...
```{r others-google, echo = FALSE, fig.align = 'center', fig.width = 3, fig.height = 2.2}
# D. Google
