...
Specifically, the Excel file on [Colours for complex graphics](https://www.uni-konstanz.de/en/university/news-and-media/create-online-and-print-media/corporate-design/colours-for-complex-graphics/) 
defines 9 additional color palettes that are exported by **unikn** as the following named color palettes: 
...
```{r pal_n, eval = TRUE, out.width = "75%", fig.asp = .75, fig.align = 'center', collapse = TRUE}
...
```{r col_scale_1, eval = TRUE, out.width = "75%", fig.asp = .75, fig.align = 'center', collapse = TRUE}
...
```{r col_scale_2, eval = TRUE, out.width = "75%", fig.asp = .75, fig.align = 'center', collapse = TRUE}
# Combining colors: ----- 
seecol(c(Seeblau, "white", Pinky), 11) 
seecol(c(Karpfenblau, Seeblau, "gold"), 10) 
```

3. Mixing and merging colors and color palettes to create new color palettes. 
For best results, consider combining existing color palettes and individual colors into new color palettes: 

```{r col_scale_3, eval = TRUE, out.width = "75%", fig.asp = .75, fig.align = 'center', collapse = TRUE}
...
```{r use_pal_demo_barplot, eval = TRUE, out.width = "75%", fig.asp = .75, fig.align = 'center', collapse = TRUE}
...
2. Visualizing various **unikn** color palettes with `image`: 

```{r use_pal_demo_image_1, eval = TRUE, fig.width = 3.5, fig.height = 4, fig.show = 'hold'}
# Random images:
set.seed(1)
n <- 20
...
3. More geometric images with `image`: 

```{r use_pal_demo_image_2, eval = TRUE, fig.width = 3.5, fig.height = 4, fig.show = 'hold'}
...
4. Using **unikn** in `ggplot` calls (using **ggplot2**):

```{r use_pal_ggplot2, eval = FALSE, out.width = "75%", fig.asp = .618, fig.align = 'center', collapse = TRUE}
