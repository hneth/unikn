...
Institutions devise corporate design (CD) manuals for creating and maintaining a consistent impression in presentations and publications. 
...
2. Functions for **viewing and comparing colors** (`seecol()`), and for **using or changing color palettes** (`usecol()`);  
3. Functions for **creating color palettes** (`newpal()`), for **finding similar colors** (`simcol()`), and for **searching color names** (`grepal()`);  
...
Computer software (R package version 0.5.0, August 15, 2022). 
