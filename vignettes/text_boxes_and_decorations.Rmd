...
<img src = "../inst/pix/unikn.png" alt = "unikn::" align = "right" width = "160px" style = "width: 160px; float: right; border:0;"/>
</a>
...
```{r mark-messy-plot, echo = TRUE, fig.width = 6, fig.height = 4, out.width = "60%"}
...
```{r mark-new-plot, echo = TRUE, fig.width = 4, fig.height = 4, out.width = "35%"}
# A sentence to plot: 
s <- c("Markieren",
       "ist ein Bestandteil",
       "von Studieren.")
