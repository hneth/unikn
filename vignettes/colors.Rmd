...
```{r my_pal_example, fig.width = 7, fig.asp = .618}
...
```{r use_col_smalln, fig.width = 3.5, fig.height = 3, fig.align = 'center', collapse = TRUE}
...
```{r use_superset, fig.width = 7, fig.height = 6, fig.align = 'center', collapse = TRUE}
seecol("all", n = 12)
...
```{r combine_pals, fig.width = 7, fig.asp = .618, fig.align = 'center'}
...
```{r combine_pals_n, fig.width = 7, fig.asp = .618, fig.align = 'center'}
