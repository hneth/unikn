...
```{r seecol_all, fig.align = 'center', fig.width = 7.2, fig.height = 6}
seecol()
```
...
```{r}
# seecol(n = 12)
# seecol(pal_unikn_plus, 12)
```

Combining color palettes: 

```{r, fig.align = 'center', fig.width = 7.2, fig.height = 5}
# seecol(pal = c(rev(pal_seeblau), "white", pal_petrol))
