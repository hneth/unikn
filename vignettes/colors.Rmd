...
**Task:** View a color palette. 

```{r seecol-example-1, fig.width = 5, fig.asp = .8, fig.align = 'center'}
seecol(hcl.colors(10, "Vik"))
```

**Task:** Compare multiple color palettes.

```{r seecol-example-2, fig.width = 6, fig.asp = 1.2, fig.align = 'center'}
# Parameters:
...
```{r newpal-example, fig.width = 5, fig.asp = .8, fig.align = 'center'}
