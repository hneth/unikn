...
seecol(list(my_pair, pal1, pal2, pal_unikn, pal_unikn_pair), 
       ...
       title = "Naming custom color palettes")
```
...
seecol(list(my_pair, pal1, pal2, pal_unikn, pal_unikn_pair), 
       ...
       title = "Comparing and naming custom color palettes")
```
...
seecol(list(pal_freiburg_basic, pal_princeton_1, pal_mpg, pal_unikn), n = 9,
       pal_names = "Freiburg", "Princeton", "Max Planck", "Konstanz",
       title = "Compare scaled color palettes")
```
