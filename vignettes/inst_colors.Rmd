...
As an example, we will re-create the color palette of the German [Max Planck Society](https://www.mpg.de/en) (which **unikn** used to export as `mpg_pal`, but see `mpg` of the **unicol** package) from the color definitions in its Corporate Design manual (available [here](https://docplayer.org/2328711-Max-planck-institut-das-erscheinungsbild-der-max-planck-gesellschaft-4-ueberarbeitete-auflage.html)). 
