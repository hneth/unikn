...
As the number of color palettes has been growing further, the color palettes from other institutions are now being collected in a separate R\ package **unicol**.
