...
Essentially, there are many alternative ways to analyze or synthesize colors, and the most appropriate representational system depends on the specific context of a particular use case. 
In R, the **grDevices** package (included in any default installation) provides colors and color-related functions. 

- `r length(colors())` named colors
