...
These 24 palettes are exported (as named vectors) and documented (to credit their contributors and sources). 
We can use and modify these palettes with the **unikn** [color functions](colors.html):

```{r show-add-pals, fig.width = 7.2, out.width = "80%", fig.asp = 1.4}
