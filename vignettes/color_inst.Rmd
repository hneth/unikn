...
uni_freiburg_blaurot <- c("#004a99", "#c1002a")
names(uni_freiburg_blaurot) <- c("uni-blau", "uni-rot")
...
# seecol(uni_freiburg_basic, n = 7)  # extend color palette
...
# seecol(list(uni_freiburg_info, uni_freiburg_basic, mpg_pal, uni_princeton_1))

# Scaled version: 
seecol(list(uni_freiburg_basic, uni_princeton_1, mpg_pal, pal_unikn), n = 9,
