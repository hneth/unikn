...
2. combine them into an R data structure (usually a data frame or named vector). 
...
```{r def-col-mpg-example, fig.width = 5, fig.asp = .95, fig.align = 'center'}
...
Unfortunately, some definitions (such as those using the subtractive CMYK model) are mostly aimed at printing (as opposed to computer screens) and other standards (such as numeric PANTONE&trade; PMS codes) are proprietary. 
But as most institutions have an interest in representing their colors in a variety of ways, they typically include translations or approximations for alternative color models in their definitions. 
