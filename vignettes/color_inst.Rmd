...
These 47\ palettes are exported (as named vectors) and documented (to credit their contributors and sources). 
We can use and modify these palettes with the **unikn** [color functions](colors.html):

<!-- Note: Duplicate image in README.Rmd -->

```{r show-add-pals, fig.width = 7.2, out.width = "550px", fig.asp = 1.8}
