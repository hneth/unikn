...
Explain how to use the `unikn` color palettes.
...
| Nr.  | Vignette | Content    |        
| ---: |:---------|:-----------|
| 1. | [Colors](1_colors.html) | Using color palettes | 
| 2. | [Text](2_text.html) | Using decorated text | 
