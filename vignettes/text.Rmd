...
The `line` command allows emphasizing text by plotting it with colored underlining (to provide the functionality of "Unterstreichen"): 
...
```{r line_ex1, echo = TRUE, fig.width = 4, fig.height = 3}
