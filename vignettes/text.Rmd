...
```{r uline-x-layout-all, echo = FALSE, eval = TRUE, fig.width = 5, fig.height = 3.5}
# (A) x_layout = "center": ---- 
s <- c("Please note:", "These text labels",
       "are centered:", ">>> <<<")
...
```{r post-x-layout-center, echo = FALSE, eval = FALSE, fig.width = 4, fig.height = 4}
# Labels to plot: 
s <- c("Please note:",
       "These text labels",
       "are centered:", 
...
```{r post-x-layout-all, echo = FALSE, eval = TRUE, fig.width = 4, fig.height = 4}
# (A) x_layout = "center": ---- 
s <- c("Note:", "Labels",
       "centered:", ">>> <<<")
...
```{r heading-demo, echo = FALSE, fig.width = 4, fig.height = 3}
...
```{r heading-warn, echo = TRUE, message = TRUE, fig.width = 4, fig.height = 3}
...
```{r heading-col, echo = TRUE, fig.width = 4, fig.height = 3}
