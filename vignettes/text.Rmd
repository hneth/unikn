...
```{r slide-def, fig.align = 'center', fig.width = 4, fig.height = 3}
...
```{r slide-col, fig.align = 'center', fig.width = 4, fig.height = 3}
...
```{r slide-dim, fig.align = 'center', fig.width = 6, fig.height = 2}
...
```{r xbox-dim, fig.align = 'center', fig.width = 2, fig.height = 4}
...
```{r mark-messy-plot, echo = TRUE, fig.width = 6, fig.height = 4}
...
```{r mark-new-plot, echo = TRUE, fig.width = 4, fig.height = 4}
# A sentence to plot: 
s <- c("Markieren",
       "ist ein Bestandteil",
       "von Studieren.")
...
```{r mark-x-layout-all, echo = FALSE, eval = TRUE, fig.width = 6, fig.height = 3.5}
# (A) x_layout = "center": ---- 
...
```{r uline-demo, echo = FALSE, fig.width = 3, fig.height = 3}
...
```{r uline-ex1, echo = TRUE, fig.width = 4.5, fig.height = 3}
...
```{r uline-ex2, echo = TRUE, fig.width = 3, fig.height = 3}
...
```{r uline-x-layout-all, echo = FALSE, eval = FALSE, fig.width = 5, fig.height = 3.5}
# (A) x_layout = "center": ---- 
s <- c("Please note:", "These text labels",
       "are centered:", ">>> <<<")
...
```{r post-demo, echo = FALSE, fig.width = 4, fig.height = 2}
...
```{r post-logo, echo = TRUE, fig.width = 2, fig.height = 2, fig.show = "hold"}
...
```{r post-logo-hide, echo = FALSE, eval = FALSE}
...
```{r post-address, echo = TRUE, fig.width = 3, fig.height = 3}
...
```{r post-x-layout-center, echo = FALSE, eval = FALSE, fig.width = 3, fig.height = 3}
# Labels to plot: 
s <- c("Please note:",
       "These text labels",
       "are centered:", 
...
```{r post-x-layout-all, echo = FALSE, eval = TRUE, fig.width = 3, fig.height = 3}
# (A) x_layout = "center": ---- 
s <- c("Note:", "Labels",
       "centered:", ">>> <<<")
...
```{r heading-demo, echo = FALSE, fig.width = 3, fig.height = 2}
...
```{r heading-warn-1, echo = TRUE, eval = TRUE, fig.align = 'center', fig.width = 3, fig.height = 3}
...
```{r heading-warn-2, echo = TRUE, message = TRUE, fig.width = 3, fig.height = 2}
...
```{r heading-col, echo = TRUE, fig.width = 3.5, fig.height = 2.5}
...
```{r heading-x-layout-center, echo = FALSE, eval = FALSE, fig.width = 4, fig.asp=1}
# Labels to plot: 
s <- c("Please note:",
       "These headings",
       "are centered:", 
...
```{r heading-x-layout-all, echo = FALSE, eval = FALSE, fig.width = 6, fig.height = 4}
# (A) x_layout = "center": ---- 
...
```{r url-post, fig.align = 'center', fig.width = 2, fig.height = 2}
